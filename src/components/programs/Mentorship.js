      ...
      <div>
        ...
        <Tab.Container defaultActiveKey="menteeRole">
          <p>
            ...
            <p>
              In this world, it could be a bit difficult to find some footing
              for a stable, independent life. Thankfully, if you are one of
              these people, you are not alone. If you become a mentee in this
              program, a mentor can show you the ropes to not only help you on
              your way to landing that six-figure job, but also help you
              navigate the pothole-filled road called life.
            </p>
            ...
            <p className="program-description">
              The deadline to apply is Sunday, February 7, 2021. Join our
              mentorship program today before it's too late!
            </p>
          </p>
          <img
            src={this.props.flyer}
