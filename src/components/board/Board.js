                  ...
                  <Tab.Content><Tab.Pane eventKey="first">
                      ...
                      <div className="all-row-leaders">
                        <div className="row-leaders centered-leader">
                          <BoardLeaders photo={IMAGES.Ashley2021} firstName="Ashley" lastName="Tran" year="2022" position="President" />
                          <BoardLeaders photo={IMAGES.Branden2021} firstName="Branden" lastName="Zamora" year="2022" position="Vice President" />
                        </div>
                        <div className="row-leaders centered-leader">
                          <BoardLeaders photo={IMAGES.Alexander2021} firstName="Alexander" lastName="Vazquez" year="2022" position="Treasurer" />
                          <BoardLeaders photo={IMAGES.Vacant} firstName="Summer" lastName="Tran" year="2022" position="Secretary" />
                        </div>
                        <div className="row-leaders centered-leader">
                          <BoardLeaders photo={IMAGES.Nshan2021} firstName="Nshan" lastName="Kazaryan" year="2022" position="Project Manager" />
                          <BoardLeaders photo={IMAGES.Patrick2021} firstName="Patrick" lastName="Sangalang" year="2022" position="Webmaster" />
                        </div>
                        <div className="row-leaders centered-leader">
                          <BoardLeaders photo={IMAGES.Vacant} firstName="Deep" lastName="Bhakta" year="2022" position="VP of Internal Affairs" />
                      ...
                      <div className="all-row-leaders">
                        <div className="row-leaders centered-leader">
                          ...
                          <BoardLeaders photo={IMAGES.Daniel2021} firstName="Daniel" lastName="Ramirez" year="2022" position="Executive Officer" />
                        </div>
                        <div className="row-leaders centered-leader">
                          <BoardLeaders photo={IMAGES.Vacant} firstName="Fabio" lastName="Carrasco" year="2022" position="Web Officer" />
                          <BoardLeaders photo={IMAGES.Gerardo2021} firstName="Gerardo" lastName="Ibarra" year="2022" position="Project Officer" />
                        </div>
                        <div className="row-leaders centered-leader">
                          <BoardLeaders photo={IMAGES.Jose2021} firstName="Jose" lastName="Zamora" year="2022" position="Project Officer" />
                      ...
                      <div className="all-row-leaders">
                        <div className="row-leaders centered-leader">
                          <BoardLeaders photo={IMAGES.Tracy2021} firstName="Tracy" lastName="Truong" year="2022" position="Design Committee" />
                          <BoardLeaders photo={IMAGES.Vacant} firstName="Katherine" lastName="Bonomo" year="2022" position="Design Committee" />
                        </div>
                        <div className="row-leaders centered-leader">
                          <BoardLeaders photo={IMAGES.Vacant} firstName="Nida" lastName="Sheikh" year="2022" position="Design Committee" />
                          <BoardLeaders photo={IMAGES.Lloyd2021} firstName="Lloyd" lastName="Castro" year="2022" position="Web Committee" />
                        </div>
                        <div className="row-leaders centered-leader">
                          <BoardLeaders photo={IMAGES.Vacant} firstName="Gabriel" lastName="Espejel" year="2022" position="Web Committee" />
                          <BoardLeaders photo={IMAGES.Vacant} firstName="David" lastName="Neilsen" year="2022" position="Project Committee" />
                        </div>
                        <div className="row-leaders centered-leader">
                          <BoardLeaders photo={IMAGES.Vacant} firstName="Ricardo" lastName="Miranda" year="2022" position="Project Committee" />
