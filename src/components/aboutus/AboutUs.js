        ...
        <div className="bottom-section">
          <Tab.Container id="top-tabs-example" defaultActiveKey="whoarewe">
            <Nav variant="tabs">
              <Nav.Item>
                <Nav.Link
                  className="project-nav-link anchor-blue"
                  eventKey="whoarewe"
                >
                  ACM
                </Nav.Link>
            ...
            <Tab.Content>
              <Tab.Pane eventKey="whoarewe">
                <Row className="info-row">
                  <Col lg={6}>
                    <div className="info-content-container">
                      <div className="info-header-container">
                        <h1 className="info-header">Who are we?</h1>
                      </div>
                      <div className="about-text">
                        <li>
                          We are a chapter of the Association for Computing
                          Machinery (ACM) at California State University, Los
                          Angeles (CSULA).
                        </li>
                        <li>
                          ACM is the world's largest educational and scientific
                          computing society, delivering resources that advance
                        ...
                        <li>
                          We bring together students with common interests into
                  ...
                  <Col lg={5}>
                    <Image src={require("./images/group.jpg")} fluid />
                  </Col>
                </Row>
              </Tab.Pane>
              <Tab.Pane eventKey="whatdoweoffer">
                <Row className="info-row">
                  <Col lg={6}>
                    <div className="info-content-container">
                      <div className="info-header-container">
                        <h1 className="info-header">What do we offer?</h1>
                      </div>
                      <div className="offer-text">
                        <li>
                          We provide professional development workshops,
                          hackathons, programming competitions, workshops, and
                          more.
                        </li>
                        <li>
                          We invite experienced guest speakers from various
                          companies, including Google, Lockheed Martin, JPL, and
                          more.
                        </li>
                        <li>
                          We host social events like hiking, game nights, and
                          movie nights, for students to network and destress
                          from classes.
                        </li>
                      </div>
                    </div>
              ...
              <Tab.Pane eventKey="howtojoinacm">
                <Row className="info-row">
                  <Col lg={6}>
                    <div className="info-content-container">
                      <div className="info-header-container">
                        <h1 className="info-header">How to join ACM?</h1>
                      </div>
                      <div className="join-text">
                        <li>
                          Although we are an organization focused on computing,
                          interested students, faculty, and alumni of all majors
                          are welcomed.
                        </li>
                        <li>
                        ...
                        <li>
                          To learn about the benefits of being an ACM member,
              ...
              <Tab.Pane eventKey="constitution">
                <Row className="info-row">
                  <Col lg={6}>
                    <div className="info-content-container">
                      <div className="info-header-container">
                        <h1 className="info-header">Our Constitution</h1>
                      </div>
                      <div className="join-text">
                        <p>
                        ...
                        <Button
                          href="https://drive.google.com/file/d/1bl3REXemVBPAyFhuoCCKbdyWLjXaoOjl/view?usp=sharing"
                          target="_blank"
                        >
                          Constitution
                        </Button>
