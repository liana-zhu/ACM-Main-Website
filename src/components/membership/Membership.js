					...
					<div className="card">
						...
						<div className="past-container">
							<Carousel
								...
								<div><Image src={require('./images/jpl_tour.png')} fluid /></div>
                                <div><Image src={require('./images/trophy.png')} fluid /></div>
                                <div><Image src={require('./images/space_invaders.png')} fluid /></div>
                                <div><Image src={require('./images/accord_workshop.png')} fluid /></div>
                                <div><Image src={require('./images/hackathon_spring_2019.png')} fluid /></div>
                                <div><Image src={require('./images/movie_fundraiser.png')} fluid /></div>
