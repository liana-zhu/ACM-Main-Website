						  ...
						  <Row>
						    ...
						    <Col sm={9}>
						      <Tab.Content className="tab-content">
						        ...
						        The first step is to make a payment. There are three different ways to make a payment as listed below.
						        Choose the most convenient method for you.<br></br><br></br>
								...
								<i>3 - Cash</i><br></br>
								Email us at acm.calstatela@gmail.com and visit our office hours at E&T C-245 from 3PM-4PM every Thursday.
						     		        <br></br>
						        <br></br>
						        <h2><span className="highlight-text"><b><i>Step Two</i></b></span> ❖ Sign-up</h2>
						        Your proof of payment can either be a
						        screenshot of your Venmo/PayPal payment or a photo of your cash receipt (from the treasurer).
